...
class Customer:
    ...
    def calc_price(self, price):
        # self.bouns_point = price * self.bouns_ratio
...
if __name__=="__main__":
    ...
    print(f'{c1.getname()}님의 구매 비용은 {c1.calc_price(price1)}원 입니다.')
    print(c1)

    c2 = Customer(1002, "슈가")
    price2 = 20000
    #cost2 = c1.calc_price(price2)
    print(f'{c2.getname()}님의 구매 비용은 {c2.calc_price(price2)}원 입니다.')
    print(c2)